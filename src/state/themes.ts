...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    map: {
      ...
      accentHi: '#F4F4F5',
      track: '#A1A1AA',
      clusterTextColor: '#0D0E0F',
      unclusteredStroke: '#0D0E0F',
      heatmapRamp: heatRamp(
        'rgba(246,244,238,0.3)',
        'rgba(246,244,238,0.5)',
        'rgba(246,244,238,0.75)',
